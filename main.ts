...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Dummy, function (sprite, otherSprite) {
    if (_2F == 2) {
        ...
        if (ButtonJudgeT == 1 && ButtonJudgeT2 == 1 && ButtonJudgeF >= 1) {
            for (let 値 of sprites.allOfKind(SpriteKind.Dummy)) {
                値.setImage(assets.image`ButtonA`)
            }
            for (let 値 of sprites.allOfKind(SpriteKind.TrueButton1)) {
    ...
    if (_3F == 2) {
        if (otherSprite == A) {
            if (pins.P0.analogRead() >= 0 && pins.P0.analogRead() < 200) {
                Mater1.setImage(assets.image`Mater1-1`)
                RightA = 0
            } else if (pins.P0.analogRead() >= 200 && pins.P0.analogRead() < 400) {
                Mater1.setImage(assets.image`Mater1-2`)
                RightA = 0
            } else if (pins.P0.analogRead() >= 400 && pins.P0.analogRead() < 600) {
                Mater1.setImage(assets.image`Mater1-3`)
                RightA = 0
            } else if (pins.P0.analogRead() >= 600 && pins.P0.analogRead() < 800) {
                Mater1.setImage(assets.image`Mater1-4`)
                RightA = 1
            } else {
                Mater1.setImage(assets.image`Mater1-5`)
                RightA = 0
            }
            ...
            mySprite.destroy()
            HintPoint.destroy()
            CardIconA = sprites.create(assets.image`CardIconA`, SpriteKind.Info)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Object, function (sprite, otherSprite) {
    ...
    if (_3F == 2) {
        if (otherSprite == Cannon) {
            if (OpenC == 0) {
                CardIconC.setImage(assets.image`CardIconC`)
        ...
        if (otherSprite == MovingButton) {
            if (pins.P1.analogRead() > 1000) {
                if (ButtonMove == 0) {
                    ...
                    AmidaPoint.setImage(assets.image`AmidaPointIcon`)
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (_3F == 2) {
        if (mySprite.overlapsWith(Board)) {
            ...
            if (LookCale == 0) {
                Calender = sprites.create(assets.image`Calender`, SpriteKind.Info)
                Calender.setPosition(mySprite.x, mySprite.y)
                controller.moveSprite(mySprite, 0, 0)
                LookCale = 1
            } else {
                Calender.destroy()
            ...
            if (LookB == 0) {
                CardB = sprites.create(assets.image`CardB`, SpriteKind.Info)
                CardB.setPosition(mySprite.x + 10, mySprite.y - 0)
                controller.moveSprite(mySprite, 0, 0)
                LookB = 1
            } else {
                CardB.destroy()
        ...
        if (OpenA == 1) {
            if (mySprite.overlapsWith(CardIconA)) {
                if (LookA == 0) {
                    CardA = sprites.create(assets.image`CardA`, SpriteKind.Info)
                    CardA.setPosition(mySprite.x + 10, mySprite.y - 0)
                    controller.moveSprite(mySprite, 0, 0)
                    LookA = 1
                } else {
                    CardA.destroy()
        ...
        if (OpenC == 1) {
            if (mySprite.overlapsWith(CardIconC)) {
                if (LookC == 0) {
                    CardC = sprites.create(assets.image`CardC`, SpriteKind.Info)
    ...
    if (_4F == 2) {
        if (mySprite.overlapsWith(Board)) {
            ...
            if (Button2Move == 0) {
                ...
                if (LookFaucet == 0) {
                    if (SetHose >= 1) {
                        Faucet = sprites.create(assets.image`FaucerHose`, SpriteKind.Info)
                    } else {
            ...
            if (MaterJudge == 1) {
                if (LookMap == 0) {
                    FloorMap = sprites.create(assets.image`Map`, SpriteKind.Info)
            ...
            if (LookBoard == 0) {
                Amida = sprites.create(assets.image`Amida`, SpriteKind.Info)
            ...
            if (LookParts == 0) {
                AmidaParts = sprites.create(assets.image`AmidaPoint`, SpriteKind.Info)
...
forever(function () {
    if (_1F == 1) {
        ...
        Exit = sprites.create(assets.image`Exit`, SpriteKind.Object)
...
forever(function () {
    if (_4F == 1) {
        ...
        Board.setImage(assets.image`CrashedBoard`)
        ...
        BreakPoint = sprites.create(assets.image`Mark1`, SpriteKind.Mark)
        ...
        FloorStocker = sprites.create(assets.image`Mark1`, SpriteKind.Info)
        tiles.placeOnTile(FloorStocker, tiles.getTileLocation(9, 8))
        HosePoint = sprites.create(assets.image`Mark1`, SpriteKind.Info)
...
forever(function () {
    if (_2F == 1) {
        ...
        ButtonTrue1 = sprites.create(assets.image`ButtonA`, SpriteKind.TrueButton1)
        tiles.placeOnTile(ButtonTrue1, tiles.getTileLocation(1, 7))
        ButtonTrue2 = sprites.create(assets.image`ButtonA`, SpriteKind.TrueButton2)
        tiles.placeOnTile(ButtonTrue2, tiles.getTileLocation(7, 3))
        Cat = sprites.create(assets.image`Cat`, SpriteKind.Info)
        ...
        HintText1 = sprites.create(assets.image`HintTxt1`, SpriteKind.Info)
        HintText1.setPosition(136, 224)
        HintText2 = sprites.create(assets.image`HintTxt2`, SpriteKind.Info)
        ...
        Display2 = sprites.create(assets.image`Monitor`, SpriteKind.Info)
        ...
        RockedDoor = sprites.create(assets.image`RockedDoor`, SpriteKind.Info)
...
forever(function () {
    if (_4F == 2) {
        if (MaterJudge == 0) {
            ...
            LightEffect.setImage(assets.image`DummyPanel4`)
        }
    }
...
forever(function () {
    if (_3F == 1) {
        ...
        SubBoard = sprites.create(assets.image`SubBoard`, SpriteKind.Info)
        ...
        Mater1 = sprites.create(assets.image`Mater1-1`, SpriteKind.Info)
        tiles.placeOnTile(Mater1, tiles.getTileLocation(6, 3))
        Mater2 = sprites.create(assets.image`Mater1-1`, SpriteKind.Info)
        tiles.placeOnTile(Mater2, tiles.getTileLocation(10, 3))
        Mater3 = sprites.create(assets.image`Mater1-1`, SpriteKind.Info)
        tiles.placeOnTile(Mater3, tiles.getTileLocation(14, 3))
        CalenderIcon = sprites.create(assets.image`CalenderIcon`, SpriteKind.Info)
        CalenderIcon.setPosition(88, 188)
        CardIconB = sprites.create(assets.image`CardIconB`, SpriteKind.Info)
        tiles.placeOnTile(CardIconB, tiles.getTileLocation(1, 14))
        HintPoint = sprites.create(assets.image`HintPoint`, SpriteKind.Mark)
...
forever(function () {
    if (AisleF == 1) {
        ...
        for (let 値 of tiles.getTilesByType(assets.tile`tile25`)) {
            Aisle = sprites.create(assets.image`Aisle`, SpriteKind.Info)
